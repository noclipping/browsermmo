...
export default async function SocialFriendsPage() {
  ...
  const [equipment, inventory, currentRegion, townRegion, combatActive, accepted] = await Promise.all([
        ...
        <div className="grid gap-4 lg:grid-cols-[minmax(16rem,1fr)_minmax(0,56rem)_minmax(16rem,1fr)] lg:items-start">
          ...
          <div className="min-w-0 space-y-4">
            ...
            <div className="rounded-2xl border border-white/20 bg-zinc-950/45 bg-linear-to-b from-black/62 via-black/78 to-black/95 p-5 shadow-md backdrop-blur-[1px]">
              <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-white/60">Social · Friends</p>
              <h1 className="mt-1 font-serif text-2xl text-zinc-100">Friends</h1>
              <p className="mt-1 text-sm text-zinc-400">
                Accepted friends only — manage incoming and outgoing on{" "}
                <Link href="/social/requests" className="text-amber-200/90 underline decoration-amber-900/50 hover:text-amber-100">
                  Requests
                </Link>
                .
              </p>
