...
export function GameTopBar({
  ...
  return (
    <header className="mb-6 flex flex-wrap items-center justify-between gap-4 rounded-xl border border-amber-900/40 bg-zinc-950/70 px-5 py-4 shadow-lg">
      <div>
        <p className="text-[10px] font-bold uppercase tracking-[0.25em] text-amber-700">Browser RPG · Phase 3</p>
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <form action={logoutAction}>
          <button type="submit" className="rounded-lg border border-zinc-700 bg-zinc-900 px-4 py-2 text-sm text-zinc-300 hover:bg-zinc-800">
            Logout
          </button>
        </form>
      </div>
